...
function theme_options_menu() {
	...
	add_menu_page('_Exiled', 'Theme Options', 'administrator', 'seachange-options', 'theme_options_page' , 'dashicons-admin-generic', 60 );
...
<form method="post" action="options.php">
  ...
  <table class="form-table">
    ...
    <tr>
      ...
      <td>
        <input id="social_instagram" name="social_vimeo" class="regular-text code" type="url" value="<?php echo get_option('social_vimeo'); ?>" />
      </td>
    </tr>
    <tr>
